...
use version;  our $VERSION = qw(1.5.5.0);
...
It comes with a copy of Subversion 1.5.5 which it will compile but only installs the Perl and Subversion libraries.  B<The subversion binaries will not be installed>.
